...
public class ShippingIntegrationService {
    ...
    public ShippingIntegrationService(OrderRepository orderRepository,
    ...
    /**
     * Dummy method to simulate sending order details to a shipping partner like
     * Shiprocket.
     */
    ...
    /**
     * Dummy method to simulate a webhook call from the shipping partner updating
     * the status.
     */
    public void simulateWebhookStatusUpdate(Order order, Order.OrderStatus newStatus, String location,
            String description) {
